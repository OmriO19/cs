...
class ShapesMaster:
    ...
    ASTEROID_1_LAYOUT = ((-10,-5),(-12,0),(-8,8),(0,13),(8,6),(14,0),(12,0),
                         (8,-6),(0,-7))
...
class Screen:
    ...
    def ontimer(self, func, milli):
        ...
        .. warning::
            ...
            **You don't need to call this method, it was already called for you
             at the end of the main game loop.**
    ...
    def draw_asteroid(self, asteroid, x, y):
        ...
        :param asteroid: This is your asteroid object (remember to register it
        before)
        :type asteroid: Asteroid
    ...
    def draw_torpedo(self, torpedo, x, y, heading):
        ...
        :param asteroid: This is your torpedo object (remember to register it
        before)
        :type asteroid: Torpedo
